...
export default function ValuesSpeakingSliderApp() {
  ...
  useEffect(() => {
    ...
    img.src = `${baseUrl}${encodeURIComponent(
      chineseValues[idx]
    )}.png`
    ...
    if (step === 0) {
      ...
      box.innerHTML = `
        ...
        <p class='${styles.pinyin}'>Wǒ juéde <span class='${styles.highlight}'>${pinyin}</span> hěn zhòngyào.</p>
